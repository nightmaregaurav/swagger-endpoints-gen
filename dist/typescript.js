...
const getNotice = (removeComment) => `${"// noinspection PointlessBooleanExpressionJS,UnnecessaryLocalVariableJS,HttpUrlsUsage,JSUnusedLocalSymbols"}

` + (removeComment
    ? ""
    : `// This file is generated using automated tool provided by NightmareGaurav (https://github.com/nightmaregaurav)
// Do not edit this file manually except for the lines annotated with a comment that ask you to fill in some details.
`);
// noinspection ES6RedundantNestingInTemplateLiteral
const getTemplateString = (removeComment, useCacheHelper) => `import axios, {AxiosError, AxiosRequestConfig, AxiosRequestHeaders, AxiosResponse, InternalAxiosRequestConfig, Method} from "axios";
