...
async function createEndpointsAndModels(options) {
    ...
    result = result.replace("<<BEARER_TOKEN_AND_LOGIN_REDIRECT_IMPORT_PATH>>", (_j = options.bearerTokenAndLoginRedirectImportPath) !== null && _j !== void 0 ? _j : "");
    result = result.replace("<<API_CALL_ERROR_HANDLER_IMPORT_PATH>>", (_k = options.apiCallErrorHandlerImportPath) !== null && _k !== void 0 ? _k : "");
...
`;
const getTemplateString = (removeComment) => `import axios, {AxiosRequestConfig, AxiosResponse, Method} from "axios";
