...
const getTemplateString: (removeComment: boolean) => string = (removeComment) => `import axios, {AxiosError, AxiosRequestConfig, AxiosResponse, InternalAxiosRequestConfig, Method} from "axios";
