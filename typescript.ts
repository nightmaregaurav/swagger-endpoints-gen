...
const getNotice: (removeComment: boolean) => string = (removeComment) => `${"// noinspection PointlessBooleanExpressionJS,UnnecessaryLocalVariableJS,HttpUrlsUsage,JSUnusedLocalSymbols"}
